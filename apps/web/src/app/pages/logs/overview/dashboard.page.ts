        ...
        <section class="grid gap-6 xl:grid-cols-[minmax(0,1.25fr)_minmax(18rem,0.75fr)]">
          ...
          <article class="rounded-base border border-border bg-card p-5">
            ...
            <div class="mt-6 grid gap-2">
              ...
              <a routerLink="/permission/catalog" class="flex items-center justify-between gap-3 border border-border p-3 text-sm text-foreground no-underline transition-colors hover:border-primary hover:text-primary"><span class="flex items-center gap-2"><Icon name="key" [size]="16" aria-hidden="true" />Permissions</span><Icon name="arrow_forward" [size]="16" aria-hidden="true" /></a>
            </div>
