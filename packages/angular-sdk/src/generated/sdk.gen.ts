 ...
 */
export const getApiV1LogsAccessLogs = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1LogsAccessLogsData, ThrowOnError>): RequestResult<GetApiV1LogsAccessLogsResponses, GetApiV1LogsAccessLogsErrors, ThrowOnError> => (options?.client ?? client).get<GetApiV1LogsAccessLogsResponses, GetApiV1LogsAccessLogsErrors, ThrowOnError>({ url: '/api/v1/logs/access-logs', ...options });

/**
 * List application logs (requires logs:log:read)
 */
export const getApiV1LogsApplicationLogs = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1LogsApplicationLogsData, ThrowOnError>): RequestResult<GetApiV1LogsApplicationLogsResponses, GetApiV1LogsApplicationLogsErrors, ThrowOnError> => (options?.client ?? client).get<GetApiV1LogsApplicationLogsResponses, GetApiV1LogsApplicationLogsErrors, ThrowOnError>({ url: '/api/v1/logs/application-logs', ...options });
