...
export const PERMISSIONS = {
  ...
  observabilityTraceRead: 'observability:trace:read',
  observabilityMetricRead: 'observability:metric:read',
  observabilityBenchmarkRead: 'observability:benchmark:read',
  observabilityAlertRead: 'observability:alert:read',
...
const descriptions: Record<KnownPermissionName, string> = {
  ...
  [PERMISSIONS.observabilityTraceRead]: 'Read runtime traces',
  [PERMISSIONS.observabilityMetricRead]: 'Read runtime metrics',
  [PERMISSIONS.observabilityBenchmarkRead]: 'Read benchmark evidence',
  [PERMISSIONS.observabilityAlertRead]: 'Read runtime alerts',
